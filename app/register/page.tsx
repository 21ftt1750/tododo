      ...
      <form onSubmit={handleSubmit} className='flex flex-col items-center w-4/12 h-80 rounded-2xl border bg-[#070019] font-mono'>
        ...
        <div className='w-full  flex justify-center'>
          <div>
            ...
            <input className='border h-7 text-xs px-2 w-80 rounded-sm flex items-center bg-[#00040D]' value={username}  onChange={(e) => setusername(e.target.value)}  required />
          </div>
        </div>
        ...
        <button type="submit" className='border h-10 text-xs px-2 mt-6 w-24 justify-center rounded-md flex items-center'>
