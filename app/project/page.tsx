...
const Page = () => {
  ...
  const [projectName, setProjectName] = useState(''); // Add this line to declare projectName
  ...
  useEffect(() => {
    ...
    // Set the projectName state variable
    setProjectName(projectNameParam);

    // Now you have projectName available
    console.log('Project Name:', projectName);

    // Additional logic if needed, e.g., fetching data based on projectId or projectName
